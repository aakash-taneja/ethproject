...
interface MessageContainerProps {
  conversation: any; // Update with the actual type of conversation
  client: any; // Update with the actual type of client
  searchTerm: string;
  isContained?: boolean;
  selectConversation: (conv: any) => void; // Update with the actual type of selectConversation
  isConsent?: boolean;
}
